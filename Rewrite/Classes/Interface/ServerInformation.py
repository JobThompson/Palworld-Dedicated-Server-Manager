...
class ServerInformation(CTkFrame):
    ...
    def __init__(self, master, **kwargs) -> None:
        ...
        self.grid(row=0, column=0, columnspan=3, padx=20, pady=20, sticky="new")
    ...
    def create_server_info(self, form):
        ...
        form.server_name.grid(row=1, column=1, padx=10, pady=(10, 0), sticky="w")
        form.server_description = CTkLabel(self, text="server_description", fg_color="transparent")
        form.server_description.grid(row=2, column=1, padx=10, pady=(10, 0), sticky="w")
        form.server_password = CTkLabel(self, text="server_password", fg_color="transparent")
        form.server_password.grid(row=3, column=1, padx=10, pady=(10, 0), sticky="w")
        form.max_players = CTkLabel(self, text="max_players", fg_color="transparent")
        form.max_players.grid(row=4, column=1, padx=10, pady=(10, 0), sticky="w")
        ...
        open_ini_file_button.grid(row=4, column=0, columnspan=4, pady=(20, 10), padx=10, sticky="esw")
